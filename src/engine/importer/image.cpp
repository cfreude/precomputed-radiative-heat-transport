...
#include <stb_image.h>
T_USE_NAMESPACE
Image* Importer::load_image_8_bit(std::string const& aFile, const int aForceNumberOfChannels) {
...
Image* Importer::load_image_16_bit(std::string const& aFile, const int aForceNumberOfChannels) {
	int width, height, channels;
