...
void handleEvent(xcb_generic_event_t *event)
{
    ...
    if (ImGui::GetCurrentContext()) {
        ...
        // dont block middle mouse button, when hovering over imgui gui (mainly used for imguizmo)
    ...
    case XCB_BUTTON_PRESS:
    {
        ...
        case 4: EventSystem::queueEvent(EventType::MOUSE_WHEEL_DELTA, Input::NONE, 0, 0, 1); break;   // wheel up
        case 5: EventSystem::queueEvent(EventType::MOUSE_WHEEL_DELTA, Input::NONE, 0, 0, -1); break;  // wheel down
        }
        break;
    }
    break;
