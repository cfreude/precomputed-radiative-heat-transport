...
Material::Material(const std::string& aName) : Asset(Asset::Type::MATERIAL, aName), mBlendMode(BlendMode::_OPAQUE), mAlphaDiscardValue(0.5f), mCullBackface(false),
// factors
...
Material* Material::alloc(const std::string& aName)
...
{ return hasEmissionTexture() || glm::any(glm::notEqual(mEmissionFactor, glm::vec3(0.0f))); }
...
{
	Material_s material = {};
	//material.index_buffer_offset = 0;
	//material.vertex_buffer_offset = 0;
	//material.has_indices = 0;
