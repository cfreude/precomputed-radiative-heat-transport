...
void ThermalImplementation::windowSizeChanged(const int aWidth, const int aHeight) {
...
void ThermalImplementation::screenshot(const std::string& aFilename)
{
...
void ThermalImplementation::prepare(renderInfo_s* aRenderInfo) {
	...
	//mThermalRenderer->prepare(mGpuBlas);
}
void ThermalImplementation::destroy() {
	mGpuTd.destroy();
	mGpuMd.destroy();
	mGpuLd.destroy();
	...
	//mThermalRenderer->destroy();
}

// scene
void ThermalImplementation::sceneLoad(scene_s aScene) {
...
void ThermalImplementation::sceneUnload(scene_s aScene) {
	mGpuTd.unloadScene();
...
// frame
void ThermalImplementation::drawView(viewDef_s* aViewDef) {
...
void ThermalImplementation::drawUI(uiConf_s* aUiConf) {
