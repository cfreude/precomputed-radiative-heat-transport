...
T_BEGIN_NAMESPACE
class ThermalImplementation final : public RenderBackendImplementation {
public:
						ThermalImplementation(rvk::LogicalDevice* aDevice, rvk::Swapchain* aSwapchain, const uint32_t aFrameCount,
							...
							mThermalRenderer(new ThermalRenderer(aDevice, aSwapchain, aFrameCount, aCurrentFrame, aGetCurrentCmdBuffer, aGetStcBuffer))
						{
						...
						~ThermalImplementation() override = default;
	...
	ThermalRenderer* getThermalRenderer() { return mThermalRenderer; }
...
private:
	...
	ThermalRenderer*										mThermalRenderer;
};
T_END_NAMESPACE